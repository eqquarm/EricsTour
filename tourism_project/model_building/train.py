...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/xgb_model.joblib"   # Specify the local file path (inside tourism_project/deployment/) where the trained model should be saved.
